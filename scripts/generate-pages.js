...
<head>
    ...
    <meta name="description" content="${product.description || product.name + ' - Felt and Yarn Product'}">
...
<body>
            ...
            <div class="product-detail-container animate-in">
                ...
                <div class="product-info">
                    <div>
                        ...
                        <h1>${product.name}</h1>
                        ${product.description ? `<p class="hero-subtitle">${product.description}</p>` : ''}
                    </div>
                    ...
                    <div class="qr-section">
                        ...
                        <img src="../qr-codes/${product.id}.png" alt="QR Code" class="qr-code-img">
                        <div style="display: flex; gap: 1rem; justify-content: center; flex-wrap: wrap;">
                            <a href="../qr-codes/${product.id}.png" download class="btn btn-primary">Download PNG</a>
                            <a href="../qr-codes/${product.id}.svg" download class="btn btn-outline">Download SVG</a>
                        </div>
                    </div>

                    ${websiteLink ? `<div class="mt-3">${websiteLink}</div>` : ''}
                </div>
            </div>
        </div>
    </main>
    ...
    <footer>
        <div class="container">
            ...
            <p><a href="${BASE_URL}/product/${product.id}.html">Share this product</a></p>
        </div>
    </footer>
</body>
</html>`;
